...
function appendTyping() {
    ...
    div.innerHTML = `
        <div
            class="w-8 h-8 rounded-full bg-brand-100 flex-shrink-0 flex items-center justify-center text-brand-600 mt-1 shadow-sm"
        >
            <svg
        ...
        while (true) {
            ...
            for (let line of lines) {
                ...
                try {
                    ...
                    // ===== SOURCES =====
                    if (data.sources && data.sources.length > 0 && !sourcesRendered) {
